"""Training loop for lunar rover hazard and navigation prediction."""
...
from ..data.dataset import RoverDataset, collate_dict_batch
...
class Trainer:
    ...
    def __init__(self, config: TrainingConfig) -> None:
        ...
        self.criterion = RoverNavigationLoss(physics_weight=config.physics_weight)
    ...
    def train_one_batch(self) -> dict[str, float]:
        ...
        dataset = RoverDataset(num_samples=self.config.batch_size, patch_size=self.config.patch_size)
