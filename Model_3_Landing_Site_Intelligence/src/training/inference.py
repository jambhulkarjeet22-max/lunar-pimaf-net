"""Inference pipeline for landing site intelligence."""
...
from Model_3_Landing_Site_Intelligence.src.models.landing_site_net import LandingSiteNet, OUTPUT_KEYS
from Model_3_Landing_Site_Intelligence.src.training.checkpoint import load_checkpoint
from Model_3_Landing_Site_Intelligence.src.training.config import PredictConfig


class InferencePipeline:
    """Load checkpoints and produce landing suitability score maps."""
