"""Attention-based multi-modal fusion for landing site intelligence."""
...
class AttentionFusion(nn.Module):
    """Learn modality weights and fuse encoded terrain features."""

    def __init__(self, feature_dim: int = 32, num_modalities: int = 6) -> None:
        super().__init__()
