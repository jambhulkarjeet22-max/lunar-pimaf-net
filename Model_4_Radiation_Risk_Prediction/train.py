#!/usr/bin/env python3
"""Train the lunar Radiation Risk Prediction model."""
...
from Model_4_Radiation_Risk_Prediction.src.training.trainer import run_training


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train Lunar Radiation Risk Prediction model.")
